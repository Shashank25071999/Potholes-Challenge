...
import 'package:adminpotholes/main.dart';
import 'package:adminpotholes/Animations/FadeAnimation.dart';
...
class LoginUserState extends State<LoginUser> {
  ...
  Future<Map<String, dynamic>> login(String email, String password) async {
    if(email!='admin@gmail.com'){
        ...
        //   builder: (BuildContext context) {
        //     return AlertDialog(
        //       title: Text('You are not authourised'),
        ...
        //     );
        //   });
          return {'success': false, 'message': "You are not authourised"};
    }
    else{
